...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// textBox4
			// 
			this->textBox4->Location = System::Drawing::Point(118, 38);
			...
			this->label1->Location = System::Drawing::Point(79, 80);
			this->label1->Name = L"label1";
			this->label1->Size = System::Drawing::Size(6, 2);
			this->label1->TabIndex = 4;
			this->label1->Text = L"label1";
			// 
			// button1
			// 
			this->button1->Location = System::Drawing::Point(80, 66);
			...
			this->ClientSize = System::Drawing::Size(238, 95);
...
#pragma endregion
	private: System::Void button1_Click(System::Object^  sender, System::EventArgs^  e) {
				 label1->Text = (Double::Parse(textBox1->Text) * Double::Parse(textBox4->Text) - 
				 Double::Parse(textBox2->Text) * Double::Parse(textBox3->Text)).ToString();

				 Form8^ form8 = gcnew Form8;
				 form8->label2->Text = label1->Text;
				 form8->ShowDialog();
	}
};
}

...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// textBox1
			// 
			this->textBox1->Location = System::Drawing::Point(14, 21);
			...
			// textBox2
			// 
			this->textBox2->Location = System::Drawing::Point(181, 21);
			...
			// button1
			// 
			this->button1->Location = System::Drawing::Point(14, 67);
			...
			// button2
			// 
			this->button2->Location = System::Drawing::Point(206, 67);
			...
			// button3
			// 
			this->button3->Location = System::Drawing::Point(111, 67);
